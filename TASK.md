...
Struct definitions and mock read/write functions for every component above are already provided (see `include/` and `src/mock_hw.c`), along with a set of predefined fault scenarios (`src/fault_scenarios.c`) you can test against.
